...
class LottoAnswerTest {
	...
	void create_fail_when_winning_numbers_count_is_not_six() {
		Set<LottoNumber> winningNumbers = lottoNumbers(1, 2, 3, 4, 5);
	...
	void create_fail_when_bonus_is_in_winning_numbers() {
		Set<LottoNumber> winningNumbers = lottoNumbers(1, 2, 3, 4, 5, 6);
	...
	void judge_first_rank() {
		LottoAnswer lottoAnswer = new LottoAnswer(lottoNumbers(1, 2, 3, 4, 5, 6), new LottoNumber(7));
